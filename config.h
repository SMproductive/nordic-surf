...
#define SETPROP(r, s, p) { \
        .v = (const char *[]){ "/bin/sh", "-c", \
             ...
             "| dmenu -fn JetBrainsMono:size=14 -nb '#2e3440' -nf '#d8dee9' -sb '#434c5e' -sf '#eceff4' -l 10 -p \"$4\" -w $1)\" && " \
...
#define SEARCH() { \
        .v = (const char *[]){ "/bin/sh", "-c", \
             ...
             "$(dmenu -fn JetBrainsMono:size=14 -nb '#2e3440' -nf '#d8dee9' -sb '#434c5e' -sf '#eceff4' -p Search: -w $1 < /dev/null)\"", \
...
static Key keys[] = {
	...
	{ MODKEY,                GDK_KEY_space,  scrollv,    { .i = +100 } },
